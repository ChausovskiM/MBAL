...
def main():
    ...
    params = curve_fit(model_experimental, kgf_experimental["P"].values, kgf_experimental["KGF_fact"].values)[0]
    ...
    params = curve_fit(model_type,df_type["P"].values,df_type["KGF"].values)[0]

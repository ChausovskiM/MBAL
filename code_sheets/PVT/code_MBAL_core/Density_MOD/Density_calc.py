...
from .Density_tab import Density_tab

def Density_calc(Metod, P_MPA, T_C, Z, m, pressure_data=None, rho_data=None):
    """
    ...
    if metod == 'корреляция':
        ...
        raise ValueError(f"Неизвестный метод расчёта плотности: '{Metod}'")
